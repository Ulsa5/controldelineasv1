...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <!-- <form action="../../api/usuarios/leerunusuario.php" method="GET"> -->
            <form action='../../api/usuarios/modificarusuarios.php?dpi={$dpi}'>
                ...
                < <table border="0" align="center" cellspacing="40px">
                    ...
                    <tr>
                        ...
                        <td height="40px" width="400px">
                            ...
                            <label for="dpi">Ingrese el DPI del usuario</label>
